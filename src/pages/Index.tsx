...
const forumPosts: ForumPost[] = [
  ...
  },
  {
    ...
    content: "Нашла его профиль... My Chemical Romance, Asking Alexandria, Bring Me The Horizon. Дух русской эмо школы!",
    replies: 67,
    time: "03:33",
    section: "Музыка"
  },
  {
    ...
    content: "Было это в 2019... Стояли на остановке под дождем. Он предложил послушать вместе \"Welcome To The Black Parade\"...",
    replies: 89,
    time: "11:11",
